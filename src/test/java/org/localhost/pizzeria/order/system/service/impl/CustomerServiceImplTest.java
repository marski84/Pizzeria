...
class CustomerServiceImplTest {
    ...
    private NewCustomerDto newCustomerDto = NewCustomerDto.builder()
            .firstName("test name")
    ...
    private  UpdateCustomerDataDto updateCustomerDataDto = UpdateCustomerDataDto.builder()
            .id(1)
            .email("updateEmail@mail.com")
            .phoneNumber("+48444000999")
...
//        then
        assertAll(
                ...
                () -> assertEquals(testCustomer.getFirstName(), foundCustomer.getFirstName()),
                () -> assertEquals(testCustomer.getLastName(), foundCustomer.getLastName()),
                () -> assertEquals(testCustomer.getEmail(), foundCustomer.getEmail()),
                () -> assertEquals(testCustomer.getPhoneNumber(), foundCustomer.getPhoneNumber())
        );
    }
...
//        when, then
        CustomerNotFoundException testResult = assertThrows(
                CustomerNotFoundException.class,
                () -> objectUnderTest.findCustomerByEmail(NON_EXISTING_CUSTOMER_EMAIL)
        );

        assertAll(
                () -> assertEquals(testResult.getMessage(), OrderExceptionsMessages.CUSTOMER_NOT_FOUND.getErrorMessage()),
                () -> assertEquals(testResult.getErrorCode(), OrderExceptionsMessages.CUSTOMER_NOT_FOUND.getErrorCode())
        );
    }
...
//        then
        assertAll(
                () -> assertEquals(testResult.getFirstName(), newCustomerDto.getFirstName()),
                () -> assertEquals(testResult.getLastName(), newCustomerDto.getLastName()),
                () -> assertEquals(testResult.getAddress(), newCustomerDto.getAddress()),
                () -> assertEquals(testResult.getEmail(), newCustomerDto.getEmail()),
                () -> assertEquals(testResult.getPhoneNumber(), newCustomerDto.getPhoneNumber())
        );
    }
...
//        given
        ...
        NewCustomerDto notUniqueEmailCustomer = NewCustomerDto.builder()
                .firstName("test name")
                .lastName("test lastname")
                .email("testEmail@test.com")
                .phoneNumber("+48111222333")
                ...
                .build();
//        when, then
        CustomerEmailNotUniqueException testResult = assertThrows(
                CustomerEmailNotUniqueException.class,
                () -> objectUnderTest.registerNewCustomer(notUniqueEmailCustomer)
        );

        assertAll(
                () -> assertEquals(
                        OrderExceptionsMessages.CUSTOMER_EMAIL_NOT_UNIQUE.getErrorCode(),
                        testResult.getErrorCode()
                ),
                () -> assertEquals(
                        OrderExceptionsMessages.CUSTOMER_EMAIL_NOT_UNIQUE.getErrorMessage(),
...
//        given
        objectUnderTest.registerNewCustomer(newCustomerDto);
        NewCustomerDto notUniquePhoneNumberCustomer = NewCustomerDto.builder()
                .firstName("test name")
                .lastName("test lastname")
                ...
                .build();
//        when, then
        CustomerPhoneNumberNotUniqueException testResult = assertThrows(
                CustomerPhoneNumberNotUniqueException.class,
                () -> objectUnderTest.registerNewCustomer(notUniquePhoneNumberCustomer)
        );

        assertAll(
                () -> assertEquals(
                        OrderExceptionsMessages.CUSTOMER_PHONE_NUMBER_NOT_UNIQUE.getErrorCode(),
                        testResult.getErrorCode()
                ),
                () -> assertEquals(
                        OrderExceptionsMessages.CUSTOMER_PHONE_NUMBER_NOT_UNIQUE.getErrorMessage(),
                        testResult.getMessage()
                )
        );
    }
...
//        when, then
        CustomerNotFoundException testResult = assertThrows(
                CustomerNotFoundException.class,
                () -> objectUnderTest.deleteCustomer(NON_EXISTING_CUSTOMER_ID)
        );
        assertAll(
                () -> assertEquals(testResult.getMessage(), OrderExceptionsMessages.CUSTOMER_NOT_FOUND.getErrorMessage()),
                () -> assertEquals(testResult.getErrorCode(), OrderExceptionsMessages.CUSTOMER_NOT_FOUND.getErrorCode())
...
//        then
        assertAll(
                () -> assertEquals(testCustomer.getId(), testResult.getId()),
                () -> assertEquals(testCustomer.getEmail(), testResult.getEmail()),
                () -> assertEquals(testCustomer.getPhoneNumber(), testResult.getPhoneNumber()),
                () -> assertEquals(testCustomer.getAddress(), testResult.getAddress())
        );
    }
...
//        when, then
        CustomerNotFoundException testResult = assertThrows(
                CustomerNotFoundException.class,
                () -> objectUnderTest.updateCustomerData(updateCustomerDataDto)
        );
